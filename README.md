# RPE Detection
#### A software package for identifying retinal pigment epithelial (RPE) cells in non-confocal adaptive optics images, using pre-trained A-GAN machine learning model and manual editing.
